...
const Experience = () => {
  const experiences = [
    {
      ...
      description: 'Contributed to the development of a responsive Doctor Appointment Booking Web Application using the MERN stack (MongoDB, Express.js, React.js, Node.js). Implemented features such as user authentication, task filtering, and real-time updates using React hooks and RESTful APIs. Collaborated with senior developers to debug, optimize performance, and ensure cross-browser compatibility.',
  ...
  const awards = [
    {
      title: 'Smart Battery Protection System',
      organization: 'Srkr',
      date: 'April 2024',
      description: 'Smart Battery Protection System is a safety solution that monitors battery health in real time and disconnects it under unsafe conditions to prevent damage and extend lifespan.',
      icon: '⚡'
    },
    {
      ...
      organization: 'Udemy',
      date: 'June 2025',
      description: 'Advanced certification in full-stack development covering MongoDB, Express, React, and Node.js for building modern web applications.',
      icon: '💻'
    },
  ];
