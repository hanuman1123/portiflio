              ...
              <div className="relative bg-black/40 backdrop-blur-lg border border-red-500/30 rounded-2xl p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4 group">
                    ...
                    <div>
                      ...
                      <p className="text-white font-medium">
                        tadijagadeeshhanuman@gmail.com
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 group">
                    ...
                    <div>
                      ...
                      <p className="text-white font-medium">+91 7893969974</p>
                    </div>
                  </div>
                ...
                <div className="mt-8 pt-8 border-t border-red-500/30">
                  ...
                  <div className="flex gap-4">
                    <a
                      href="https://github.com/hanuman1123/"
                      target="_blank"
                    ...
                    <a
                      href="https://www.linkedin.com/in/jagadeesh4123"
                      target="_blank"
                      className="group p-3 bg-red-500/20 rounded-lg hover:bg-red-500 transition-all duration-300 transform hover:scale-110"
                    >
                    ...
                    <a
                      href="mailto:tadijagadeeshhanuman@gmail.com"
                      target="_blank"
                      className="group p-3 bg-red-500/20 rounded-lg hover:bg-red-500 transition-all duration-300 transform hover:scale-110"
                    >
